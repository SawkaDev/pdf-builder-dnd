...
export const Sidebar: React.FC<SidebarProps> = ({ selectedComponent, updateComponent }) => {
  ...
  const handleTextChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    updateComponent({ ...selectedComponent, content: e.target.value } as TextComponentData);
  };
